...
<script>
	$(document).ready(function(){
		...
		$('#dataContainer').load('accounting_card_500_all_data.php');
		$('#search').on('keyup', function(){
			var value = $(this).val().toUpperCase();
			$.post("accounting_card_500_all_data.php",{searchClient: value},function(result){
...
<div class = "main">
	<div class='pageTitle'><i class="fa fa-gears"></i>GSAT CARD 500 MONITORING</div>
	<div class='box'>
			<input type="search" name="search" id='search' placeholder="Search GSat Card Records!...">
