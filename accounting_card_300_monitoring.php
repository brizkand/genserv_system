...
<script>
	$(document).ready(function(){
		...
		$('#dataContainer').load('accounting_card_300_all_data.php');
	});
</script>
</head>
...
<div class = "main">
	<div class='pageTitle'><i class="fa fa-gears"></i>GSAT CARD 300 MONITORING</div>
	<div class='box'>
			<input type="search" name="search" id='search' placeholder="Search GSat card package 300 records!...">
